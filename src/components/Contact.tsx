          ...
          <div className="max-w-4xl mx-auto space-y-6">
            {[
              ...
              },
              {
                ...
                answer: "Все начинается с разговора. Во время общения мы узнаем о ваших целях, потребностях и возможностях, а затем рекомендуем услуги и технологические решения, лучше всего подходящие для ваших потребностей."
              },
              {
                question: "Предлагаете ли вы индивидуальные решения?",
                answer: "Безусловно! Мы предлагаем гибкий подход, основанный на поэтапной, итеративной разработке продуктов, подбираем фрейворки и инструменты под специфику проекта для достижения максимального эффекта."
              },
              {
