            ...
            <div className='container mx-auto px-4'>
                <div className='grid grid-cols-1 md:grid-cols-4 gap-8'>
                    ...
                    <div className='col-span-1 md:col-span-2'>
                        ...
                        <p className='muted-text max-w-md'>Помогаем технологиям помогать бизнесу.</p>
                    </div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                            ...
                            <li>
                                <div className='flex gap-5 items-center justify-start group'>
                                    <a
                                        ...
                                        className='font-ksbistra muted-text hover:text-primary-foreground transition-colors'
                                    >
                                        {CONTACT_INFO.email}
                                    </a>
                                    <button
                ...
                <div className='border-t border-border mt-8 pt-8 text-center'>
                    <p className='font-ksbistra muted-text'>© 2025 SOLARM Tech. Все права защищены.</p>
                </div>
            </div>
        </footer>
    );
